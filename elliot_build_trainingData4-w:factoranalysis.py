...
def main():
    ...
    regular_season_games = BuildGamesMatrix('data/kaggle/regular_season_results.csv', 80543, 85863)
    ...
    tournament_games = BuildGamesMatrix('data/kaggle/tourney_results.csv', 1090, 1158)
    #print tournament_games
    print len(tournament_games)
    ...
    for index,predict in enumerate(predictions):
        if (predict == 1):
            print (id_to_team_name[int(tournament_games[index][0])], id_to_team_name[int(tournament_games[index][1])])
        else:
            print (id_to_team_name[int(tournament_games[index][1])], id_to_team_name[int(tournament_games[index][0])])
...
def BuildTeamNameToIdMap(filename):
    ...
    for row in content:
        ...
        id_to_team_name[int(row_split[0])] = row_split[1]
